...
- Create the object `OR`: Use `coef()` on the model object to extract the coefficients of the model and then apply the `exp` function on the coefficients.
...
loss_func(class = alc$probability, prob = 1)
...
loss_func(class = alc$prediction, alc$high_use)
